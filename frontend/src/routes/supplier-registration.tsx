...
const documentList: DocumentRequirement[] = [
  ...
  { id: "taxClearance", label: "Tax Clearance Certificate", required: false, description: "Required for Tier 1 classification." },
  { id: "sectorLicence", label: "Trade / Sector Licence", required: false, description: "E.g., construction grading certificate, import/export licence." },
]
...
export const Route = createFileRoute("/supplier-registration")({
  ...
  head: () => ({
    meta: [
      {
        title: "Supplier Registration - SCF",
      },
    ],
  }),
})
...
function SupplierRegistration() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    console.log("Submitting supplier registration:", finalData)
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Card>
                        ...
                        <CardContent className="space-y-2">
                          ...
                          <p className="text-sm"><strong>Entity Type:</strong> {form.getValues("entity_type")}</p>
                        </CardContent>
                      </Card>
                ...
                {step === 1 && (
                  <div className="text-center text-sm pt-4 border-t">
                    ...
                    <RouterLink to="/login" className="underline underline-offset-4 text-primary">
                      Log in
                    </RouterLink>
                  </div>
                )}
